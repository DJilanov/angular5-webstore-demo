...
export class Config {
    ...
    // urls
    // public static get productsAndCategoriesUrl():string { return "http://0f12af35.ngrok.io/api/productsAndCategories"; }
    // public static get categoriesUrl():string { return "http://0f12af35.ngrok.io/api/categories"; }
    // public static get productsUrl():string { return "http://0f12af35.ngrok.io/api/products"; }
    // public static get messageUrl():string { return "http://0f12af35.ngrok.io/api/message"; }
    // public static get orderUrl():string { return "http://0f12af35.ngrok.io/api/order"; }
    // public static get adminLoginUrl():string { return "http://0f12af35.ngrok.io/api/admin/login"; }
